...
const pathLocations1 =[
  ...
  const drawer = (
    ...
    <div>
      <div style={{display: "flex", boxSizing: "border-box", margin:"0rem", padding: "0rem", height:"4rem", justifyContent:"center", }}>
    <Button startIcon={<GridViewIcon/> } size="large">MDash</Button>
    </div>
      <Divider/>
      <List >
